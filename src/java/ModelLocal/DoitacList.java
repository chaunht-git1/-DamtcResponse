...
public class DoitacList {
    ...
    private String giaophieuweb;
    private String importweb;
    ...
    public String getTygiaapdung() {
        return tygiaapdung;
    }

    public void setTygiaapdung(String tygiaapdung) {
    ...
    public String getGiaophieuweb() {
        return giaophieuweb;
    }

    public void setGiaophieuweb(String giaophieuweb) {
        this.giaophieuweb = giaophieuweb;
    }

    public String getImportweb() {
        return importweb;
    }

    public void setImportweb(String importweb) {
        this.importweb = importweb;
    }
